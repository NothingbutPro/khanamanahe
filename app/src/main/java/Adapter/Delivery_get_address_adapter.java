...
public class Delivery_get_address_adapter extends RecyclerSwipeAdapter<Delivery_get_address_adapter.MyViewHolder> {
    ...
    private String getsocity, gethouse, getphone, getpin, getname, getcharge, getadresdeliver, getarea, getnewaddr, gettype;
    public static String getId;
    private Session_management management;

    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView tv_address, tv_name, tv_phone, tv_charges, tv_adres_deliver, tv_adres_area, tv_address_new;
        public RadioButton rb_select;
        public LinearLayout layoutAddress, layoutTrain;
        ...
        public MyViewHolder(View view) {
            ...
            tv_adres_area = (TextView) view.findViewById(R.id.tv_adres_area);
            tv_address_new = (TextView) view.findViewById(R.id.tv_address_new);
            layoutAddress = (LinearLayout) view.findViewById(R.id.layoutAddress);
            layoutTrain = (LinearLayout) view.findViewById(R.id.layoutTrain);
            ...
            rb_select.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    location_id = modelList.get(clickedPos).getUser_id();

                    gethouse = modelList.get(clickedPos).getCoach_no();
                    getname = modelList.get(clickedPos).getBerth_no();
                    getphone = modelList.get(clickedPos).getTrain_no();
                    getarea = modelList.get(clickedPos).getArea();
                    gettype = modelList.get(clickedPos).getAddressType();
                    getnewaddr = modelList.get(clickedPos).getNewAddress();
                    getId = modelList.get(clickedPos).getId();
                    management.setOtp(getId);
...
*/
    ...
    public Delivery_get_address_adapter(Context context, List<Delivery_address_model> modelList) {
        this.modelList = modelList;
        management=new Session_management(context);
    }
    ...
    public void onBindViewHolder(final Delivery_get_address_adapter.MyViewHolder holder, final int position) {
        ...
        String id = mList.getId();
        String berth_no = mList.getBerth_no();
        String train_no = mList.getTrain_no();
        String coatch_no = mList.getCoach_no();
        String pnr_no = mList.getPnr_no();
        String addresstype = mList.getAddressType();
        String area = mList.getArea();
        String addrnew = mList.getNewAddress();
        //holder.tv_phone.setText(berth_no);

       /* if (addresstype == "train") {
            holder.tv_name.setText(train_no);
            holder.tv_charges.setText(berth_no);
            holder.tv_adres_deliver.setText(coatch_no);
        } else if (addresstype == "Home") {
            holder.tv_adres_area.setText(area);
            holder.tv_address_new.setText(addrnew);
        }*/

        if (addresstype.equals("train")) {
            holder.layoutTrain.setVisibility(View.VISIBLE);
            holder.layoutAddress.setVisibility(View.GONE);
            holder.tv_name.setText(train_no);
            holder.tv_charges.setText(berth_no);
            holder.tv_adres_deliver.setText(coatch_no);
        } else if (addresstype.equals("Home")) {
            holder.layoutTrain.setVisibility(View.GONE);
        ...
        if (position == 0 && mList.getIscheckd() && holder.rb_select.isChecked()) {
            ...
            location_id = modelList.get(0).getUser_id();

            gethouse = modelList.get(0).getCoach_no();
            getname = modelList.get(0).getBerth_no();
            getphone = modelList.get(0).getTrain_no();
            gettype = modelList.get(0).getAddressType();
            getarea = modelList.get(0).getArea();
            getnewaddr = modelList.get(0).getNewAddress();
        ...
        holder.buttonDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ConnectivityReceiver.isConnected()) {
                    makeDeleteAddressRequest(mList.getUser_id(), position);
                }
        ...
        holder.btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                args.putString("user_id", mList.getUser_id());
                args.putString("train_no", mList.getTrain_no());
                args.putString("berth_no", mList.getBerth_no());
                args.putString("pnr_no", mList.getPnr_no());
                args.putString("coach_no", mList.getCoach_no());
    ...
    public String gettrain() {
       /* String address = context.getResources().getString(R.string.reciver_name) + getname + "\n" + context.getResources().getString(R.string.reciver_mobile) + getphone +
        ...
        String trainaddress = context.getResources().getString(R.string.train_no) + getphone + "\n" + context.getResources().getString(R.string.berth) + getname + "\n" + context.getResources().getString(R.string.coach) + gethouse;
    ...
    private void makeDeleteAddressRequest(String location_id, final int position) {
        ...
        params.put("user_id", location_id);
