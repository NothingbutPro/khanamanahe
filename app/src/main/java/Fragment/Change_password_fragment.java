...
public class Change_password_fragment extends Fragment {
    ...
    private void attemptChangePassword() {
        ...
        if (TextUtils.isEmpty(get_new_pass)) {
            tv_new_pass.setTextColor(getResources().getColor(R.color.red));
        ...
        if (TextUtils.isEmpty(get_old_pass)) {
            tv_old_pass.setTextColor(getResources().getColor(R.color.red));
        ...
        if (TextUtils.isEmpty(get_con_pass)) {
            tv_con_pass.setTextColor(getResources().getColor(R.color.red));
